...
/*calcute layer num, for IOT test*/
unsigned long l0_num5;
unsigned long l1_num5;
unsigned long l2_num5;
unsigned long l3_num5;
unsigned long l4_num5;
unsigned long l5_num5;
unsigned long l6_num5;
unsigned long l0_num8;
unsigned long l1_num8;
unsigned long l2_num8;
unsigned long l3_num8;
unsigned long l4_num8;
unsigned long l5_num8;
unsigned long l6_num8;
unsigned long layer_config_num;

void layer_num5_cal(int layer)
{
	int layer_num;
...
void layer_num_get_state(void)
{
	DISPCHECK("-[C]15:%lu,%lu,%lu,%lu,%lu,%lu,%lu,l8:%lu,%lu,%lu,%lu,%lu,%lu,%lu;%lu-\n",
			l0_num5, l1_num5, l2_num5, l3_num5, l4_num5, l5_num5, l6_num5,
			l0_num8, l1_num8, l2_num8, l3_num8, l4_num8, l5_num8, l6_num8,
			layer_config_num);
}
			     ...
			     disp_path_handle disp_handle, cmdqRecHandle cmdq_handle)
{
	...
	unsigned int layer_num5 = 0;
	unsigned int layer_num8 = 0;
	...
	for (i = 0; i < cfg->input_layer_num; i++) {
		...
		/*for IOT test*/
		screen_size = pgc->plcm->params->width*pgc->plcm->params->height;
		if (2 * ovl_cfg->src_w * ovl_cfg->src_h > screen_size)
			layer_num5++;
		if (5 * ovl_cfg->src_w * ovl_cfg->src_h > 4 * screen_size)
			layer_num8++;
	}
		/*==for IOT test==*/
		layer_num5_cal(layer_num5);
		layer_num8_cal(layer_num8);
		layer_config_num++;
		if (layer_config_num%500 == 0) {
			DISPMSG("-[C]15:%lu,%lu,%lu,%lu,%lu,%lu,%lu,l8:%lu,%lu,%lu,%lu,%lu,%lu,%lu;%lu-\n",
						l0_num5, l1_num5, l2_num5, l3_num5, l4_num5, l5_num5, l6_num5,
						l0_num8, l1_num8, l2_num8, l3_num8, l4_num8, l5_num8, l6_num8,
						layer_config_num);
		}
...
user_cmd_unlock:
	...
	MMProfileLogEx(ddp_mmp_get_events()->primary_display_cmd, MMProfileFlagEnd, cmdqsize,
		       0);
...
err:
	...
	if (ret)
		DISPERR("primary display switch mode failed\n");
	if (need_lock)
		_primary_path_unlock(__func__);
