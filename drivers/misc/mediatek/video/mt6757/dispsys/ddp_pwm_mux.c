...
#define DEFAULT_CALI		(0x00A40E2B)
#define ULP_FQMTR_MIDDLE	(0x3D8A)
#define ULP_FQMTR_CEIL		(0x4277)
#define ULP_FQMTR_FLOOR		(0x389E)
...
uint32_t disp_pwm_get_ulposc_meter_val(uint32_t cali_val)
{
...
void disp_pwm_ulposc_cali(void)
{
	...
	uint32_t left = 0, right = 0x3f, middle;
