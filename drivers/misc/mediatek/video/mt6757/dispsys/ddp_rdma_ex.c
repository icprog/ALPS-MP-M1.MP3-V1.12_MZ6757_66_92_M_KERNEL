...
int rdma_reset_by_cmdq(DISP_MODULE_ENUM module, void *handle)
{
	int ret = 0;
	unsigned int idx = rdma_index(module);
...
static int rdma_build_cmdq(DISP_MODULE_ENUM module, void *handle, CMDQ_STATE state)
{
	if (handle == NULL) {
