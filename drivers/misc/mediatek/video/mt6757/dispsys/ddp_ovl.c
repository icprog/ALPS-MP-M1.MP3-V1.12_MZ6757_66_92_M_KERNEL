...
int disable_ovl_layers(DISP_MODULE_ENUM module, void *handle)
{
 ...
 */
static int ovl_layer_layout(DISP_MODULE_ENUM module, disp_ddp_path_config *pConfig)
{
...
static int ovl_config_l(DISP_MODULE_ENUM module, disp_ddp_path_config *pConfig, void *handle)
{
	...
	for (layer_id = 0; layer_id < TOTAL_OVL_LAYER_NUM; layer_id++) {
		OVL_CONFIG_STRUCT *ovl_cfg = &pConfig->ovl_config[layer_id];
