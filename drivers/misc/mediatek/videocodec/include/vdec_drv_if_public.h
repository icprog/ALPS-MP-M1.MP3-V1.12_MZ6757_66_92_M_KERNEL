...
typedef enum _VDEC_DRV_GET_TYPE_T {
	...
	*/
	...
	VDEC_DRV_GET_TYPE_CODEC_PROPERTY,               /* /< get the codec specific property for decode flow*/
...
typedef enum _VDEC_DRV_SET_TYPE_T {
	...
	VDEC_DRV_SET_TYPE_SET_WAIT_KEYFRAME,            /* /< set wait keyframe mode */
...
typedef struct __VDEC_DRV_CALLBACK_T_ { /* union extend 64bits for TEE */
	...
	union {
		VAL_UINT32_T (*pfnGetOutputBuffer)(
			VAL_HANDLE_T,
			P_VDEC_DRV_FRAMEBUF_T *,
			VAL_UINT32_T,
			VAL_BOOL_T,
