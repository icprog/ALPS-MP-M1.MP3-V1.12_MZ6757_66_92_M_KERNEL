...
#define BATTERY_MODULE_INIT
	...
	|| defined(CONFIG_MTK_RT9468_SUPPORT)
...
#define MANUFACTUREID 1
#define CV_LIMIT 6000
#define BAT_UPPER_BOUND 4350
#define BAT_LOWER_BOUND 3000
#define CV_END 6000
#define CC_SS_INIT 1500 /*ma*/
#define CC_INIT 5000 /*ma*/
#define CC_MAX 6500
#define CC_END 2000 /*ma*/
#define CC_STEP 200 /*ma*/
#define CC_SS_STEP 500 /*ma*/
#define CC_SS_BLANKING 100 /*ms*/
#define CC_BLANKING 1000
#define CHARGER_TEMP_MAX 70
#define BATTERY_TEMP_MAX 50
#define VBUS_OV_GAP 100
#define FOD_CURRENT 200
#define R_VBAT_MIN 40
#define R_SW_MIN 20
#define PE30_MIN_CHARGE_TEMPERATURE -10
