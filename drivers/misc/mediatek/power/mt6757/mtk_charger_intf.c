...
int mtk_charger_sw_init(void *data)
{
	int ret = 0;
...
int mtk_charger_set_power_off(void *data)
{
	int ret = 0;
...
int mtk_charger_get_power_source(void *data)
{
	int ret = 0;
...
int mtk_charger_get_csdac_full_flag(void *data)
{
	return -ENOTSUPP;
}

int mtk_charger_set_error_state(void *data)
{
	int ret = 0;

	charging_error = *(u32 *)(data);
	chr_control_interface(CHARGING_CMD_SET_HIZ_SWCHR, &charging_error);

	return ret;
}

int mtk_charger_diso_init(void *data)
{
	int ret = 0;
...
int mtk_charger_get_diso_state(void *data)
{
	int ret = 0;
...
int mtk_charger_set_vbus_ovp_en(void *data)
{
	int ret = 0;
	u32 enable = *((u32 *)data);
...
int mtk_charger_get_bif_vbat(void *data)
{
	int ret = 0;
	u32 vbat = 0;
...
int mtk_charger_set_chrind_ck_pdn(void *data)
{
	int ret = 0;
	u32 pwr_dn;
...
int mtk_charger_get_bif_tbat(void *data)
{
	int ret = 0, tbat = 0;
...
int mtk_charger_set_dp(void *data)
{
	int ret = 0;
...
int mtk_charger_get_bif_is_exist(void *data)
{
	int bif_exist = 0;
